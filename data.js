const portfolioData = {
    profile: {
        ...
        tagline: "13년간의 경험을 바탕으로 대규모 시스템 구축부터 구독 서비스, 글로벌 상품 기획까지 성공적인 프로젝트를 이끌어왔습니다.",
        about: "저는 사용자 중심의 제품 설계와 데이터 기반의 시장 분석을 통해 차별화된 기획 역량을 발휘하는 상품기획 전문가입니다. 지난 13년간 골프존 그룹에서 대규모 직영 시스템 구축, 신규 구독 서비스 론칭, 글로벌 시장 대응 등 다양한 프로젝트를 성공적으로 이끌며 PM으로서의 역량을 입증했습니다. 일정 관리, 예산 조율, 그리고 여러 부서와의 긴밀한 협업을 통해 항상 목표를 달성해왔습니다.",
    ...
    experience: [
        {
            ...
            achievements: [
                ...
                "High-End 스윙 분석기 상품기획: 최상위 스윙 분석기 기획 및 글로벌 상품 북미 론칭."
            ]
        },
        {
